...
export default function TopNavbar({ user = { name: 'Mo老师', role: 'AI · 高级教师' } }: TopNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 h-16 bg-white border-b border-gray-100">
      <div className="h-full max-w-[1800px] mx-auto px-6 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
          <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-sky-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
        ...
        <nav className="flex items-center gap-1">
          {navItems.map((item) => (
            ...
            >
              <span className={isActive(item.href) ? 'text-blue-500' : 'text-gray-400'}>
                {item.icon}
              </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-sky-600 flex items-center justify-center text-white font-semibold text-sm shadow-lg shadow-blue-500/20">
