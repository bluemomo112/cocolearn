      ...
      <div className="fixed right-0 top-0 h-full w-[400px] bg-white shadow-2xl z-50 flex flex-col animate-slide-in-right">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="border-b border-gray-100">
            ...
            {expandedSections.includes('basic') && (
              <div className="px-6 pb-4 space-y-4">
                {/* 学习方式 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">学习方式</label>
                ...
                {/* AI 风格 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">AI 风格</label>
                  <select
                ...
                {/* 笔记模板 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">笔记模板</label>
                  <select
          ...
          <div className="border-b border-gray-100">
            ...
            >
              <div className="flex items-center gap-2">
                <span className="font-medium text-gray-900">高级设置</span>
                <span className="text-xs px-2 py-0.5 bg-gray-100 text-gray-600 rounded">高级</span>
              </div>
            ...
            {expandedSections.includes('advanced') && (
              <div className="px-6 pb-4 space-y-4">
                {/* 知识边界 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">知识边界</label>
                  <select
                ...
                {/* 能力追踪维度 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">能力追踪维度</label>
                  <div className="space-y-2">
                    {['critical_thinking', 'information_synthesis', 'metacognition'].map(dim => (
                      <label key={dim} className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700">
                          {dim === 'critical_thinking' ? '批判性思维' : dim === 'information_synthesis' ? '信息整合' : '元认知'}
                        </span>
                      </label>
                    ))}
                  </div>
          ...
          <div className="border-b border-gray-100">
            ...
            >
              <div className="flex items-center gap-2">
                <span className="font-medium text-gray-900">专家模式</span>
                {!expertModeUnlocked ? (
                  <button
            ...
            {expertModeUnlocked && expandedSections.includes('expert') && (
              <div className="px-6 pb-4 space-y-4">
                {/* 自定义 AI 指令 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">自定义 AI 指令</label>
                  <textarea
                ...
                {/* 学习流程 */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">学习流程</label>
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                  >
                    <option value="5E">5E 教学法</option>
                    <option value="PBL">PBL 问题式学习</option>
                    <option value="feynman">费曼技巧</option>
