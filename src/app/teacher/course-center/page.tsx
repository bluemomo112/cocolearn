          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select
                ...
                className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              >
              ...
              <div className="relative">
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 w-48"
                />
                <svg
      ...
      {courses.map((course, index) => (
        ...
        >
          ...
          <div className="p-4">
            ...
            {/* Action Button */}
            <button className="w-full px-4 py-2.5 bg-primary-600 text-white font-medium rounded-xl hover:bg-primary-700 transition-colors">
              去授课
            </button>
          </div>
        </div>
              ...
              {courses
                ...
                .map((course) => (
                  <div key={course.id} className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50">
                    ...
                    <button className="px-3 py-1.5 bg-primary-100 text-primary-600 text-xs font-medium rounded-lg hover:bg-primary-200">
                      查看
                    </button>
                  </div>
                ))}
