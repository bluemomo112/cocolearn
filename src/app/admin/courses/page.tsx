                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    {course.status === 'pending' ? (
                      <button
                        onClick={() => openReviewModal(course)}
                        className="flex-1 px-3 py-2 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 transition-colors"
                      >
                        审核
                      </button>
                    ) : (
          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-scale-in">
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <textarea
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"
                  rows={3}
                  placeholder="请输入驳回原因..."
                ></textarea>
              </div>
