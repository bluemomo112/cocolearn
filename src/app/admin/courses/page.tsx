...
const subjectColors: Record<string, string> = {
  ...
  '音乐': 'bg-accent-100 text-accent-600',
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    {course.status === 'pending' ? (
                      <button
                        onClick={() => openReviewModal(course)}
                        className="flex-1 px-3 py-2 bg-primary-600 text-white text-sm font-medium rounded-xl hover:bg-primary-700 transition-colors"
                      >
                        审核
                      </button>
                    ) : (
